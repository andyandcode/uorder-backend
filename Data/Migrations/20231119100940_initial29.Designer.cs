...
namespace Data.Migrations
{
    ...
    [Migration("20231119100940_initial29")]
            ...
            modelBuilder.Entity("Data.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "110116-191123-293484",
                            CreatedAt = new DateTime(2023, 11, 19, 17, 9, 40, 629, DateTimeKind.Local).AddTicks(3623),
            ...
            modelBuilder.Entity("Data.Entities.Dish", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 19, 17, 9, 40, 624, DateTimeKind.Local).AddTicks(2952));
            ...
            modelBuilder.Entity("Data.Entities.Media", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 19, 17, 9, 40, 627, DateTimeKind.Local).AddTicks(2002));
            ...
            modelBuilder.Entity("Data.Entities.Menu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 19, 17, 9, 40, 627, DateTimeKind.Local).AddTicks(8241));
